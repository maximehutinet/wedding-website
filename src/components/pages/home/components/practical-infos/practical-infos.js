        ...
        <div>
            ...
            <div id="where-do-we-meet-wrapper">
                ...
                <div id="meeting-point">
                    {t('practical_infos.in_front_of')} <a href="https://goo.gl/maps/di9HkMD8HftHQcMA8" target="_blank" rel="noreferrer">Banque Populaire
            ...
            <div id="where-can-i-park-wrapper">
                ...
                <p>
                    {t('practical_infos.parking_content_1')} <a href="https://goo.gl/maps/jKkJfY3QEHWQpKXG9" target="_blank" rel="noreferrer">Parking centre village</a>. {t('practical_infos.parking_content_2')}
                </p>
                <div className="iframe-wrapper">
                    <iframe
                        title="Parking"
